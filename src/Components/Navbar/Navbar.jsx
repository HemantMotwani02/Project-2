...
function Header(props) {
    ...
    return (
        <>
            <div style={{ display: 'flex', border: '1px solid #F0F0F0', padding: '10px 25px', width: '80vw', justifyContent: "space-between", alignItems: 'center', borderRadius: '0.6em', margin: '10px 0',position:'relative' }}>
